...
| <a name="module_sqs_status_recorder"></a> [sqs\_status\_recorder](#module\_sqs\_status\_recorder) | https://github.com/NHSDigital/nhs-notify-shared-modules/releases/download/v2.0.30/terraform-sqs.zip | n/a |
