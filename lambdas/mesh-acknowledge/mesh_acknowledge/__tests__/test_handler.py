...
def setup_mocks(config_cls,
    ...
    config = Mock()
    config.event_bus_arn = "arn:aws:eventbridge:eu-west-2:123456789012:event-bus/test"
    config.event_publisher_dlq_url = "https://sqs.eu-west-2.amazonaws.com/123456789012/dlq"
    ...
    return (config_cm, config, event_publisher, acknowledger, processor, sender_lookup, boto_client)
...
class TestHandler:
    ...
    def test_handler_passes_correct_parameters(
        ...
        boto3_client_cls.assert_called_once_with("ssm")
