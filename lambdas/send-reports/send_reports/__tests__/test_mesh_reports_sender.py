...
@pytest.fixture(name='mesh_reports_sender')
def create_mesh_reports_sender(mock_mesh_client, mock_logger):
...
class TestMeshReportsSender:
    ...
    def test_send_report_sends_correct_message(
        self, mesh_reports_sender, mock_mesh_client
    ):
        ...
        mesh_reports_sender.send_report(reporting_mailbox, report_bytes, report_date)
